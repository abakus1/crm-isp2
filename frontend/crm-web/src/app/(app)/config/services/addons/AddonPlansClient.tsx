  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <SimpleModal
        ...
        description={detailsPlan ? `${detailsPlan.name} • ${detailsPlan.type}` : undefined}
          ...
          <div className="space-y-3 text-sm">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <div className="font-mono text-xs">{detailsPlan.id}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Billing code</div>
                <div className="font-mono text-xs">{detailsPlan.billingProductCode}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Kategoria</div>
                <div>{famById.get(detailsPlan.familyId) || "—"}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Okres</div>
                <div>{termById.get(detailsPlan.termId) || "—"}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Status</div>
                <div>{formatStatus(detailsPlan.status)}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Subskrybenci</div>
                <div className="tabular-nums">{detailsPlan.subscribersCount ?? 0}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">M1 (zł)</div>
                <div className="tabular-nums">{(detailsPlan.monthPrices?.[0] ?? 0).toFixed(2)}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Aktywacja (zł)</div>
                <div className="tabular-nums">{(detailsPlan.activationFee ?? 0).toFixed(2)}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Sprzedaż od</div>
                <div className="tabular-nums">{detailsPlan.saleFrom}</div>
              </div>
              <div>
                <div className="text-xs text-muted-foreground">Sprzedaż do</div>
